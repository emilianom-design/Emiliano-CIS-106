...
def calculate_paint():
    ...
    try:
        ...
        messagebox.showerror("Input Error", "Please enter numeric values for dimensions.")
        return
...
root = tk.Tk()
root.title("Room Paint Estimator")
...
tk.Button(root, text="Calculate", command=calculate_paint).grid(row=4, columnspan=2)
